  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="order in tradeList.detailArrayList"
          :key="order.skuId"
        >
          <li class="list-img">
            <img
          ...
          <li class="list-tiny">X{{ order.skuNum }}</li>
          <li class="list-tiny">有货</li>
        </ul>
      </div>
      <div class="bbs">
        <h5>买家留言：</h5>
    ...
    <div class="trade">
      <div class="price">
        应付金额:　<span>¥{{ tradeList.originalTotalAmount }}</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.defaultAddress.consignee, //最终收件人名字
        consigneeTel: this.defaultAddress.phoneNum, //最终收件人电话
  ...
  computed: {
    ...mapState({
      addressInfo: (state) => state.trade.addres,
